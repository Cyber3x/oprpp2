...
public class PersistentParamGetFunction implements SmartScriptFunction{
    @Override
    public void execute(ObjectMultistack multistack, RequestContext requestContext) {
        ...
        String paramValue = requestContext.getPersistentParameter(paramName.getValue().toString());
