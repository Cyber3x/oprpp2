...
public class TemporaryParamGetFunction implements SmartScriptFunction {
    @Override
    public void execute(ObjectMultistack multistack, RequestContext requestContext) {
        ...
        String paramValue = requestContext.getTemporaryParameter(paramName.getValue().toString());
